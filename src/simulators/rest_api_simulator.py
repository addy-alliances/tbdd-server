...
class RestApiSimulator(Simulator):
	"""Execute REST API requests and normalize their responses."""
	...
	def execute(
		...
		if json_body is not None:
			...
			if isinstance(body, (dict, list, int, float, bool)) and (
				not content_type_header or "json" in content_type_header.lower()
			):
